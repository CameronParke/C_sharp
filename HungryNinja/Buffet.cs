...
namespace HungryNinja
{
    class Buffet
    {
        ...
        public Buffet()
        {
            Menu = new List<Food>()
            {
                new Food("A Nashville Fried Chicken Sandwich", 750, true, false),
                new Food("A Chocolate Milk Shake", 775, false, true),
                new Food("Chili", 350, true, false),
                new Food("A Double Cheeseburger", 865, false, false),
