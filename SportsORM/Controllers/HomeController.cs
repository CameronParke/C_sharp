...
namespace SportsORM.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Level1()
        {
            ...
            ViewBag.NoJoshua = _context.Players.Where(l => l.LastName.Contains("Cooper") && !l.FirstName.Contains("Joshua")).ToList();
            ViewBag.AlexOrWyatt = _context.Players.Where(l => l.FirstName.Contains("Alexander") || l.FirstName.Contains("Wyatt")).ToList();
            return View();
        }
